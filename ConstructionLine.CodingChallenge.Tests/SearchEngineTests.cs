...
namespace ConstructionLine.CodingChallenge.Tests
{
    ...
    public class SearchEngineTests : SearchEngineTestsBase
    {
        ...
        [Test]
        public void ShouldReturnCorrectResultsWhenQueriedUsingSingleCategoryForColor()
        {
            var shirts = new List<Shirt>
            {
                new Shirt(Guid.NewGuid(), "Red - Small", Size.Small, Color.Red),
        ...
        [Test]
        public void ShouldReturnCorrectResultsWhenQueriedUsingSingleCategoryForSize()
        {
            var shirts = new List<Shirt>
            {
                new Shirt(Guid.NewGuid(), "Red - Small", Size.Small, Color.Red),
        ...
        [Test]
        public void ShouldReturnCorrectResultsWhenQueriedUsingNoSearchOptions()
        {
            var shirts = new List<Shirt>
            {
                new Shirt(Guid.NewGuid(), "Red - Small", Size.Small, Color.Red),
